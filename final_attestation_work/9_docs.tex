...
\item
\textbf{Управление связанными сущностями}:
...
выпуска и т.д.). 
\item 
\textbf{Genres}: Список жанров, к которым могут
относиться фильмы. 
\item 
\textbf{Directors}: Информация о режиссерах. 
\item 
\textbf{Tags}: Теги для фильмов, которые помогают в классификации и
поиске. 
\item 
\textbf{Ratings}: Рейтинги, оставленные пользователями. 
\item 
...
взаимосвязи. 
    \item 
\textbf{Диаграмма последовательностей}: Показывает, как
...
\textbf{Docker Compose} для контейнеризации и управления зависимостями.
    \item
\textbf{Python 3.x} для работы с бэкендом. 
    \item
\textbf{PostgreSQL} в
...
\begin{itemize}
    \item
\textbf{DATABASE\_URL}: URL для подключения к базе данных.
    \item
...
\begin{itemize}
    \item 
\textbf{Пользователями}
(\texttt{/api/v1/users/}). 
    \item 
\textbf{Комментариями}
(\texttt{/api/v1/comments/}). 
    \item 
\textbf{Жанрами}
(\texttt{/api/v1/genres/}). 
    \item 
\textbf{Тегами} (\texttt{/api/v1/tags/}).
    \item 
